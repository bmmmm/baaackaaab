...
struct CLIArguments {
    ...
    static let valueFlags: Set<String> = [
        ...
        "--limit-upload", "--pack-size", "--rest-connections", "--repo-quota", "--config", "--restic-repo", "--host", "--run-tag",
    ...
    static let boolFlags: Set<String> = [
        ...
        "--pause-drill-timer", "--resume-drill-timer",
        "--pause-check-timer", "--resume-check-timer",
